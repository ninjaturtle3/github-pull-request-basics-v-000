...
oops! not to worry! when you find a mistake simply fix it and then commit and push...since the pull request already exists the repo will be automatically updated 
